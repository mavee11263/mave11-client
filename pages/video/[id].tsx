      ...
      <main className="lg:px-20 md:px-12 px-4 flex flex-col w-full">
        <div className="grid grid-cols-7 lg:gap-12 md:gap-8 gap-4 pt-8">
          <div className="lg:col-span-5 md:col-span-6 col-span-7">
            <VideoPlayer />
            <div className="flex py-8 dark:text-gray-200 text-gray-900 w-full flex-row items-center">
              <p className="font-semibold flex-1">
                Iam a video added by a user click me to play
              </p>
              <div className="flex flex-row items-center justify-between space-x-2 dark:text-gray-200 text-gray-700">
                <span>
          ...
          {/* // ads component */}
          <div className="lg:col-span-2 cols-span-1 md:flex hidden flex-col w-full">
            <div className="uu bg-green-200 w-full">ads go here</div>
          </div>

          {/* // related videos component */}
          <div className="flex py-4 col-span-7 border-t border-gray-400 dark:border-gray-500 dark:text-gray-200 text-gray-700 w-full font-semibold">
            Related Videos
          </div>
        </div>
